...
class F5BigIpLtmMonitorRadius(F5BigIpNamedObject):
    def set_crud_methods(self):
        self.methods = {
            ...
            'read': self.mgmt_root.tm.gtm.monitor.radius_s.radius.load,
            'update': self.mgmt_root.tm.gtm.monitor.radius_s.radius.update,
            'delete': self.mgmt_root.tm.gtm.monitor.radius_s.radius.delete,
            'exists': self.mgmt_root.tm.gtm.monitor.radius_s.radius.exists
        }
