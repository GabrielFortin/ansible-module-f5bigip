...
DOCUMENTATION = '''
---
module: f5bigip_gtm_monitor_mysql
short_description: BIG-IP gtm monitor mysql module
description:
...
class F5BigIpGtmMonitorMysql(F5BigIpNamedObject):
    def _set_crud_methods(self):
        self._methods = {
            'create': self._api.tm.gtm.monitor.mysqls.mysql.create,
            'read': self._api.tm.gtm.monitor.mysqls.mysql.load,
            'update': self._api.tm.gtm.monitor.mysqls.mysql.update,
            'delete': self._api.tm.gtm.monitor.mysqls.mysql.delete,
            'exists': self._api.tm.gtm.monitor.mysqls.mysql.exists
        }
...
def main():
    ...
    try:
        obj = F5BigIpGtmMonitorMysql(check_mode=module.check_mode, **module.params)
        result = obj.flush()
