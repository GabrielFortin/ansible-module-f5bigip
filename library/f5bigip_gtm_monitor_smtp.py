...
BIGIP_GTM_MONITOR_SMTP_ARGS = dict(
...
class F5BigIpGtmMonitorHttp(F5BigIpNamedObject):
    def set_crud_methods(self):
        self.methods = {
            'create': self.mgmt_root.tm.gtm.monitor.smtps.smtp.create,
            'read': self.mgmt_root.tm.gtm.monitor.smtps.smtp.load,
            'update': self.mgmt_root.tm.gtm.monitor.smtps.smtp.update,
            'delete': self.mgmt_root.tm.gtm.monitor.smtps.smtp.delete,
            'exists': self.mgmt_root.tm.gtm.monitor.smtps.smtp.exists
        }


def main():
    module = AnsibleModuleF5BigIpNamedObject(argument_spec=BIGIP_GTM_MONITOR_SMTP_ARGS, supports_check_mode=False)
