...
DOCUMENTATION = '''
---
module: f5bigip_gtm_monitor_firepass
short_description: BIG-IP gtm monitor firepass module
description:
...
EXAMPLES = '''
- name: Create GTM Monitor Firepass
  f5bigip_gtm_monitor_firepass:
...
class F5BigIpGtmMonitorFirepass(F5BigIpNamedObject):
    def _set_crud_methods(self):
        self._methods = {
            'create': self._api.tm.gtm.monitor.firepass_s.firepass.create,
            'read': self._api.tm.gtm.monitor.firepass_s.firepass.load,
            'update': self._api.tm.gtm.monitor.firepass_s.firepass.update,
            'delete': self._api.tm.gtm.monitor.firepass_s.firepass.delete,
            'exists': self._api.tm.gtm.monitor.firepass_s.firepass.exists
        }
...
def main():
    ...
    try:
        obj = F5BigIpGtmMonitorFirepass(check_mode=module.check_mode, **module.params)
        result = obj.flush()
