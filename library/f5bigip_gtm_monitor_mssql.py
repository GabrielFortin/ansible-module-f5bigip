...
DOCUMENTATION = '''
---
module: f5bigip_gtm_monitor_mssql
short_description: BIG-IP gtm monitor mssql module
description:
...
class F5BigIpGtmMonitorMssql(F5BigIpNamedObject):
    def _set_crud_methods(self):
        self._methods = {
            'create': self._api.tm.gtm.monitor.mssqls.mssql.create,
            'read': self._api.tm.gtm.monitor.mssqls.mssql.load,
            'update': self._api.tm.gtm.monitor.mssqls.mssql.update,
            'delete': self._api.tm.gtm.monitor.mssqls.mssql.delete,
            'exists': self._api.tm.gtm.monitor.mssqls.mssql.exists
        }
...
def main():
    ...
    try:
        obj = F5BigIpGtmMonitorMssql(check_mode=module.check_mode, **module.params)
        result = obj.flush()
